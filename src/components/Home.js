  ...
  return (
    <div id="Home" className="homeContainer">
      <div
        ...
        style={{ backgroundImage: `url(https://i.imgur.com/RS097Vt.jpg)` }}
      ></div>
      <div className="home-ContentContainer">
        ...
        <div className="homeText-container">
          <p className="homeText">
            A very passionate and motivated Full Stack Developer with a solid
            MERN Stack and Agile Metodologies management. Always ready to apply
            what I know and learn about what I dont.
          </p>
        </div>
        <div className="home-divisorLine"></div>
        <div className="homeIcons-container">
          <a
            href="https://www.linkedin.com/in/mateo-lorenzo-4518121b5/"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <a href="#aboutMe_Container" className="downArrow-container">
        <Icon
          icon={arrowDownAlt2}
          className={
            downArrowIsHovered ? "downArrow-active" : "downArrow-inactive"
          }
          onMouseOver={() => setDownArrowIsHovered(true)}
          onMouseLeave={() => setDownArrowIsHovered(false)}
        />
      </a>
    </div>
  );
