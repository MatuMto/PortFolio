  ...
  return (
    <div id="prueba" className="footerContainer">
      <div className="contentContainer">
        <a
          href="#Home"
          onMouseOver={() => setUpArrowIsHovered(true)}
          onMouseLeave={() => setUpArrowIsHovered(false)}
        >
          <Icon
            icon={arrowUpAlt2}
            className={
              upArrowIsHovered ? "upArrow-icon-active" : "upArrow-icon-inactive"
            }
          />
        </a>
        ...
        <div className="footerText">
          © 2021 - Developed with{" "}
          <Icon icon={heartSolid} className="heart-icon" /> by Mateo Lorenzo
        </div>
      </div>
    </div>
  );
